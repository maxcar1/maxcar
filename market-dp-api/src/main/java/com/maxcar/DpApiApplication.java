...
@PropertySource(value = {"classpath:dubbo.properties","classpath:dasouche.properties","classpath:file.properties", "classpath:redis-config.properties","classpath:oos.properties"})
