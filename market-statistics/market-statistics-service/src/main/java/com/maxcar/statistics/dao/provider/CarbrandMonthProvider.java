...
public class CarbrandMonthProvider {

    public String  groupCarbrandInvoiceMonth(GroupCarbrandInvoiceMonthRequest parameter){
        return new SQL() {{
            ...
            FROM(" (SELECT COUNT(*),\n" +
                    ...
                    "    FROM\n" +
                    "      `maxcar_statistics_l`.`carbrand_month` " + parameter.getSelectCondition() +
    ...
    public String  groupCarbrandInventoryMonth(GroupCarbrandInventoryMonthRequest parameter){
        return new SQL() {{
