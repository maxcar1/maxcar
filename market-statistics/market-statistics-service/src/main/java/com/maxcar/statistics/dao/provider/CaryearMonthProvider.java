...
public class CaryearMonthProvider {

    public String  groupCaryearInvoiceMonth(GroupCaryearInvoiceMonthRequest parameter){
        return new SQL() {{
            ...
            FROM(" (SELECT COUNT(*),\n" +
                    ...
                    "    FROM\n" +
                    "      `maxcar_statistics_l`.`caryear_month` " + parameter.getSelectCondition() +
    ...
    public String  groupCaryearInventoryMonth(GroupCaryearInventoryMonthRequest parameter){
        return new SQL() {{
