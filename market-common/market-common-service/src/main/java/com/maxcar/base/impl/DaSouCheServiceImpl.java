...
public class DaSouCheServiceImpl implements DaSouCheService {
    ...
    @Override
    public int syncDaSouCheBrand(List<CarBrand> carBrands) {
        try {
            return carBrandMapper.syncDaSouCheBrand(carBrands);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    @Override
    public int syncDaSouCheSeries(List<CarSeries> carSeries) {
        try {
            return carBrandMapper.syncDaSouCheSeries(carSeries);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
    ...
    @Override
    public int syncDaSouCheModel(List<CarModel> carModels) {
        try {
            return carBrandMapper.syncDaSouCheModel(carModels);
        } catch (Exception e) {
            e.printStackTrace();
        }
        return -1;
