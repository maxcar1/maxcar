...
public class Car extends Page{
    ...
    private Date minCarTime;
    private Date maxCarTime;
    ...
    private String vin;
		...
		public Date getMinCarTime() {
			return minCarTime;
		}
		public void setMinCarTime(Date minCarTime) {
			this.minCarTime = minCarTime;
		}
		public Date getMaxCarTime() {
			return maxCarTime;
		}
		public void setMaxCarTime(Date maxCarTime) {
