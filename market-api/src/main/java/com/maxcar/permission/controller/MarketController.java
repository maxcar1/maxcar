...
public class MarketController extends BaseController {
    ...
    */
    ...
    public InterfaceResult save(@RequestBody @Valid Market market, BindingResult result,HttpServletRequest request, HttpServletResponse response)throws Exception {
        InterfaceResult interfaceResult = new InterfaceResult();
        //参数验证
        if(result.hasErrors()){
