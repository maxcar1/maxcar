...
//              int parkCount = 0;
    ...
    private void selectAll(String marketId, GetCarSpaceAndOfficeByMarketIdOrAreaIdRequest requests, List<UserTenant> userTenantsList, ArrayList<ResponseStorageCapacity> RSCList) throws Exception {
        for (UserTenant userTenant : userTenantsList) {
            ...
            storageCapacity.setWarehouse(tenantIdOrAreaId == null ? 0 : tenantIdOrAreaId.getWarehouse());
            storageCapacity.setTemporaryCarSpace(tenantIdOrAreaId == null ? 0 : tenantIdOrAreaId.getTemporaryCarSpace());
            storageCapacity.setOther(tenantIdOrAreaId == null ? 0 : tenantIdOrAreaId.getOther());
