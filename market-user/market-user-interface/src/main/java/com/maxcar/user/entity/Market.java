...
//    private String tenantAppId;
    ...
    @NotNull(message = "过户费用不能为空")
    private Integer changeTheNamePrice;// 过户费

    @NotNull(message = "物业合同不能为空")
    private String contractProperty; //物业合同服务器存放地址

    private String contractTrading; // 交易合同服务器存放地址

    private String responsibility; // 责任书oss地址

    private String supplementary; // 补充协议oss地址

    private String alipayAppid; // 支付宝支付APPId商户私钥
     ...
     * 是否提供质保服务 1.是 0.否
     */
    private Integer qualityServiceSwitch = 0;

    /**
     * 质保服务费用 单位元
     */
    private Integer qualityServiceFee = 0;

    private String contractPropertyName;// 物业合同文件名字
    private String contractTradingName;// 交易合同文件名字
    private String responsibilityName;// 责任书文件名字
    private String supplementaryName;// 补充协议文件名字
    ...
    public String getContractTradingName() {
        return contractTradingName;
    }

    public void setContractTradingName(String contractTradingName) {
        this.contractTradingName = contractTradingName;
    }
    ...
    public Integer getChangeTheNamePrice() {
        return changeTheNamePrice;
    }

    public void setChangeTheNamePrice(Integer changeTheNamePrice) {
        this.changeTheNamePrice = changeTheNamePrice;
    }
    ...
    public String getContractTrading() {
        return contractTrading;
    }

    public void setContractTrading(String contractTrading) {
        this.contractTrading = contractTrading;
    }
...
//    private String monitoringUnit;
    ...
    public Integer getQualityServiceSwitch() {
        return qualityServiceSwitch;
    }

    public void setQualityServiceSwitch(Integer qualityServiceSwitch) {
        this.qualityServiceSwitch = qualityServiceSwitch;
    }

    public Integer getQualityServiceFee() {
        return qualityServiceFee;
    }

    public void setQualityServiceFee(Integer qualityServiceFee) {
        this.qualityServiceFee = qualityServiceFee;
    }
}