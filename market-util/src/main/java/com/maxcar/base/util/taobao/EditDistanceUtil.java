package com.maxcar.base.util.taobao;
...
public class EditDistanceUtil {  
    ...
    public static void main(String[] args) {  
    	...
    	l.add("1.4TSI 手动 豪华版");
    	l.add("1.4TSI 手动 技术版");
    	l.add("1.4TSI 双离合 豪华版");
    	l.add("1.4TSI 双离合 技术版");
    	l.add("1.8TSI 手动 冠军版");
    	l.add("1.8TSI 手自一体 冠军版");
    	
        String s = "大众速腾 2010款  速腾  1.4TSI 自动技术型", t="1.8T 手自一体 运动尊享型"; 
        for (String string : l) {
        	int d = getEditDistance(s, string);  
