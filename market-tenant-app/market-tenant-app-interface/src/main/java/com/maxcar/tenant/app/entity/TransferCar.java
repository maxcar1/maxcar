...
public class TransferCar implements Serializable {
    ...
    public String getFieldValue(String fieldName)  {
        try {
            ...
            if ("buyerSign".equals(fieldName)) {
                if (StringUtils.isBlank(this.buyerSign)) {
                    return "";
                }

                return "<img src='" + this.buyerSign + "' height='100px' />";
            }

            if ("sellerSign".equals(fieldName)) {
                if (StringUtils.isBlank(this.sellerSign)) {
                    return "";
                }

                return "<img src='" + this.sellerSign + "' height='100px' />";
            }

            if ("checkOutPhoto".endsWith(fieldName)) {
                if (StringUtils.isBlank(this.checkOutPhoto)) {
                    return "";
                }

                return "<div class='downRight' id='wJD'>" +
                        "<span class='picDown'>外检单照片</span>" +
                        "<img class='imgDownLeft' alt='' src='" + checkOutPhoto + "'/></div>";
            }
