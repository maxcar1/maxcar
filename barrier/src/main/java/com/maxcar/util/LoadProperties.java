...
public class LoadProperties {
    ...
    public static String getProperties_3(String filePath, String keyWord){
        ...
        String value = null;
        try {
            InputStream inputStream = LoadProperties.class.getResourceAsStream(filePath);
            prop.load(inputStream);
            value = prop.getProperty(keyWord);
        } catch (IOException e) {
            e.printStackTrace();
    ...
    public static void main(String[] args) {
        // 注意路径问题
//        InputStream inStream = LoadProperties.class.getClassLoader().getResourceAsStream("application.properties");
        getProperties_3("../../../application.properties");
        System.out.println();
//        String properties_1 = getProperties_1("application.properties", "mqtt.push.topic");
//        System.out.println("wechat_appid = " + properties_1);
//        getProperties_1("com/test/config/config.properties");
//        System.out.println("*********************************************");
        // 注意路径问题
//        String properties_2 = getProperties_2("classpath:application.properties", "mqtt.push.topic");
//        System.out.println("jdbc.url = " + properties_2);
//        getProperties_2("application.properties");
//        System.out.println("*********************************************");
        // 注意路径问题
//        String properties_3 = getProperties_3("application.properties", "wechat_appid");
