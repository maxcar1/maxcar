...
//        int maxActive = Integer.parseInt(LoadProperties.getProperties_3("../../../application.properties","redisMaxActive"));
//        int maxIdle = Integer.parseInt(LoadProperties.getProperties_3("../../../application.properties","redisMaxIdle"));
//        int maxWait = Integer.parseInt(LoadProperties.getProperties_3("../../../application.properties","redisMaxWait"));
//
//        String ip = LoadProperties.getProperties_3("../../../application.properties","redisHost");;
//        String pwd = LoadProperties.getProperties_3("../../../application.properties","redis.password");;
//        int port = Integer.parseInt(LoadProperties.getProperties_3("../../../application.properties","redisPort"));
//
...
//            log.debug("Could not get a resource from the pool");
...
//        map.put("openId", 1);
//
//        String werwe = RedisUtil.getInstance().strings().set("k2", "1111");
//        RedisUtil.getInstance().keys().expire("k2", 20);
...
//        System.out.println(RedisUtil.getInstance().getJedis().get("k2"));
