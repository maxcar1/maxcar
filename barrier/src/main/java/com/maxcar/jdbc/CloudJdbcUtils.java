...
public class CloudJdbcUtils {
    ...
    static {
        try {
            ...
            url = LoadProperties.getProperties_3("../../../application.properties","cloud.jdbc.url");
//            url = url+"&characterEncoding=utf-8";
//            url = "jdbc:mysql://192.168.3.58:3306/maxcar?useSSL=false&characterEncoding=utf-8";
            username = LoadProperties.getProperties_3("../../../application.properties","cloud.jdbc.username");
            password = LoadProperties.getProperties_3("../../../application.properties","cloud.jdbc.password");
//            username = "root";
