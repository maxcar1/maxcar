package com.maxcar.core.utils.redis;
...
public class RedisUtil {
    ...
    private void initJedisPool() {
        ...
        int maxActive = Integer.parseInt(properties.getString("redis.pool.maxActive"));
        int maxIdle = Integer.parseInt(properties.getString("redis.pool.maxIdle"));
        int maxWait = Integer.parseInt(properties.getString("redis.pool.maxWait"));

        String ip = properties.getString("redis.ip");
        String pwd = properties.getString("redis.pwd");
        int port = Integer.parseInt(properties.getString("redis.port"));
