...
import com.maxcar.core.entity.common.PostParam;
...
public class Result implements Serializable{
	...
	public static Result okJson(PostParam jsonObject) {
		return ok(ResultCode.CREATE_SUCCESS.getCode(), "修改成功", jsonObject);
	}

	public static Result okJson(String message, PostParam jsonObject) {
